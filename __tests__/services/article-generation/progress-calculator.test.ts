...
import { calculateArticleProgress } from '../progress-calculator'
...
describe('Progress Calculator Service', () => {
  describe('calculateArticleProgress', () => {
    ...
    it('should calculate ETA correctly for in-progress articles', () => {
      ...
      // 5 minutes elapsed, 1 section completed = 5 min per section average
      // 2 remaining sections = 10 minutes remaining
      // ETA should be approximately 5 minutes from now
      expect(result.timing.averageSectionDurationSeconds).toBe(300) // 5 minutes
