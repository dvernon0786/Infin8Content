    ...
    <div className={styles.page}>
      <div className={styles.layout}>
          ...
          <div className={styles.signupCardWrapper}>
            <div className={styles.container}>
              <div className={`${styles.card} ${styles.darkCard}`}>
                <div className={`${styles.header} ${styles.leftAlignedHeader}`}>
                  {/* Brand Logo */}
                  <img
                  ...
                  <h1 className={`${styles.title} ${styles.whiteTitle}`}>Create Account</h1>
                  <p className={`${styles.subtitle} ${styles.graySubtitle}`}>
          ...
          <div className={styles.formGroup}>
            ...
            <div className="relative">
              <input
                ...
                className={`${styles.input} ${styles.darkInput} pr-10`}
                required
                minLength={8}
        ...
        <div className={styles.footer}>
          <p className={`${styles.footerText} ${styles.grayFooterText}`}>
            Already have an account?{' '}
            <Link href="/login" className={`${styles.link} ${styles.primaryLink}`}>
              Sign in
            </Link>
          </p>
        </div>
