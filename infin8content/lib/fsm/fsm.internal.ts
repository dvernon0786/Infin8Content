/**
 * Internal FSM Implementation - PRIVATE
 * 
 * This file contains the actual FSM implementation.
 * It is NOT exported and cannot be imported from outside the unified engine.
 * 
 * All state transitions MUST go through unified-workflow-engine.ts
 */
...
/**
 * INTERNAL FSM CLASS - NOT EXPORTED
 * 
 * This class contains the pure state machine logic.
 * No logging, no emission, no warnings.
 * Pure state transitions only.
 */
class InternalWorkflowFSM {
...
// Internal export only for unified engine - DO NOT USE ELSEWHERE
// This is a deliberate export for the unified engine only
export { InternalWorkflowFSM }
