...
//
// ⚠️ DEPRECATED: This client uses the deprecated /v3/content_generation/generate_sub_topics/live endpoint
// The Step 8 subtopic generator has been migrated to OpenRouter (see subtopic-generator.ts)
// This file is kept for backward compatibility and may be used by other parts of the system
// Consider replacing with SERP + related + questions hybrid or remove entirely
    ...
    async generateSubtopics(
      ...
      for (let attempt = 0; attempt < this.maxRetries; attempt++) {
        try {
          ...
          // Parse and validate subtopics (defensive parsing - no brittle type filtering)
