...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background-color: ${accentColor}; color: #ffffff; padding: 30px; border-radius: 8px;">
    <div style="background-color: #ffffff; color: #333333; padding: 30px; border-radius: 6px;">
      ${body}
    </div>
